...
namespace CloutCast
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.ConfigureSwagger(Program.ThisAssembly, "Clout.Cast Api");
        }

        protected virtual void ConfigureAuthorization(IServiceCollection services, AuthenticationOption settings)
        {
            services
